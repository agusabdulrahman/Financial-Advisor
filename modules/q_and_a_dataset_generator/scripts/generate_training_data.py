...
PROMPT_TEMPLETE = """
ou are an expert in the stock and crypto markets. I will give you some information about myself and you will provide me with good investment advice.
...
openai.api_key = os.eviron["OPENAI_API_KEY"]

def build_prompt(example: Dict) -> str:
    return PROMPT_TEMPLETE.format(
